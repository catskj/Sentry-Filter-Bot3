...
# Bot information
API_ID = environ.get('API_ID', '2910103634')
if len(API_ID) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '7025034430 5583670042')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002340398350').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002469477854')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1004618461915')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://dannycarter191:fWpepK8ULoJbxZPL@cluster0.jp0uv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/Movie_Groupssssss')
OWNER_USERNAME = environ.get("OWNER_USERNAME", "https://t.me/NeverStopI")
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/+HfhtKOPJ5vcyYTY9')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/+rVZKFxytYFBiZmI1')
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002370440811")
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://t.me/+8wLbjdTJkCFhN2M1")
if len(URL) == 0:
